...
local benchmark3 = Benchmarker.new(1e3, 2, false, false, true)
...
--benchmark3:compare(math.floor, math.round, 1, 10.4144, 10.4144 )
Benchmarker:benchmark(math.floor, 10.4144)
benchmark3:benchmark(math.floor, 10.4144)
